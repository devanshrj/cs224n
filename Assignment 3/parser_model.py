...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        # index_select selects appropriate indices and then view to reshape
        indices = torch.index_select(self.embeddings, 0, w.view(-1))
        x = indices.view(-1, self.n_features * self.embed_size)
